...
basic_parser.add_argument('--works_dir', metavar='DIR', help='the path to workspace dir', default="/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/")

# data configures
basic_parser.add_argument('--speech_dir', metavar='DIR', help='path to clean speech', default='/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/data/speech')
basic_parser.add_argument('--noisy_dir', metavar='DIR', help='path to noisy speech', default='/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/data/noisy')
basic_parser.add_argument('--noise_dir', metavar='DIR', help='path to noise', default='/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/data/noise')

basic_parser.add_argument('--specially_speech_dir', metavar='DIR', help='path to special clean wakeup speech', default='/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/xiaodu_data/speech')
basic_parser.add_argument('--specially_noisy_dir', metavar='DIR', help='path to special noisy wakeup speech', default='/home/snie/works/train_am/am_train/egs/xiaoduxiaodu/xiaodu_data/noisy')
basic_parser.add_argument('--specially_noise_dir', metavar='DIR', help='path to noise', default=None)

basic_parser.add_argument('--num_workers', type=int, default=4, help='the number of workers')
basic_parser.add_argument('--num_utt_per_loading', type=int, default=20, help='the number of utterances for each loading')

basic_parser.add_argument('--num_models', type=int, default=5, help='the number of models for saving to disk')

basic_parser.add_argument('--pos_batch_size', type=int, default=500, help='the size of positive samples in one batch')
basic_parser.add_argument('--neg_batch_size', type=int, default=600, help='the size of negtivate samples in one batch')

basic_parser.add_argument('--pos_phone_file', default = 'pos_phone.npy', type = str, help='File to pos_phone_id')
...
basic_parser.add_argument('--left_context_width', type=int, default=5, help='input left_context_width')
basic_parser.add_argument('--right_context_width', type=int, default=5, help='input right_context_width')
basic_parser.add_argument('--feat_step', type=int, default=1, help='the sampling step of the feats for NN input')
...
basic_parser.add_argument('--use_data_balance', default=0, type=int, help='use date_rate to balance data for training)')
basic_parser.add_argument('--num_utt_data_rate', default=30000, type=int, help='Number of utts for compute the data distrubution')
basic_parser.add_argument('--data_rate_file', default = None, type = str, help='File to data_rate')
basic_parser.add_argument('--pos_rate_thresh', default=0.0, type=float, help='the thresh to decide the block being positive')

basic_parser.add_argument('--specially_speech_rate', type=int, default=5, help='the number of specially clean speech for one loading')
basic_parser.add_argument('--specially_noisy_rate', type=int, default=25, help='the number of specially noisy speech for one loading')
basic_parser.add_argument('--specially_noise_rate', type=int, default=0, help='the number of common noise for one loading')

basic_parser.add_argument('--speech_rate', type=int, default=4, help='the number of clean speech for one loading')
basic_parser.add_argument('--noisy_rate', type=int, default=20, help='the number of noisy speech for one loading')
basic_parser.add_argument('--noise_rate', type=int, default=2, help='the number of common noise for one loading')
basic_parser.add_argument('--babble_rate', type=int, default=3, help='the number of babble noise for one loading')
...
basic_parser.add_argument('--continue_from_name', default='best', type=str, help="None|'best'|'latest' Continue from checkpoint model")

basic_parser.add_argument('--save_freq_steps', type=int, default=10000, help='frequency of saving the latest results')
basic_parser.add_argument('--save_by_steps', type=bool, default=False, help='Use binary or not, true for use, otherwise')
...
# optimizer
basic_parser.add_argument('--epochs', default=5, type=int, help='Number of maximum epochs')
...
basic_parser.add_argument('--lr', type=float, default=0.001, help='initial learning rate for adam')
...
# for warmup
basic_parser.add_argument('--lr_factor_freq_step', default=500000, type=int, help='the frequence step of reducing the lr_factor to one half')
basic_parser.add_argument('--lr_factor', default=1.0, type=float, help='default = 1.0 tunable scalar multiply to learning rate')
...
basic_parser.add_argument('--binary', type=bool, default=False, help='Use binary NN or not, true for use, otherwise')
...
basic_parser.add_argument('--num_classes', type=int, default=44, help='num_classes')
basic_parser.add_argument('--bias', type=bool, default=True, help='whether to add bias')
...
basic_parser.add_argument('--visdom_id', default='wakeup_xiaodu', help='Identifier for visdom run')
...
basic_parser.add_argument('--isTrain', type=bool, default=True, help='Use binary or not, true for use, otherwise')
...
basic_parser.add_argument('--verbose', type=bool, default=True, help='Use binary or not, true for use, otherwise')
basic_args = basic_parser.parse_args()

# configure for In DeepFF
in_deepff_parser = argparse.ArgumentParser(description='In DeepFF')
in_deepff_parser.add_argument('--hlayer_size', default='800-400-400-400-400', type=str, help='Hidden size of In DeepFF')
...
in_deepff_parser.add_argument('--batch_norm', type=bool, default=False, help='whether to perform LayerNorm')
in_deepff_parser.add_argument('--dropout', default=0.0, type=float, help='dropout rate')
in_deepff_parser.add_argument('--bias', type=bool, default=True, help='whether to add bias')
...
transformer_parser.add_argument('--batch_norm', type=bool, default=True, help='whether to perform LayerNorm')
transformer_parser.add_argument('--residual_op', type=bool, default=True, help='whether to perform Residual')
...
out_deepff_parser.add_argument('--batch_norm', type=bool, default=False, help='whether to perform LayerNorm')
out_deepff_parser.add_argument('--dropout', default=0.1, type=float, help='dropout rate')
out_deepff_parser.add_argument('--bias', type=bool, default=True, help='whether to add bias')
out_deepff_args = out_deepff_parser.parse_args()

print(basic_args)

# CUDA_VISIBLE_DEVICES=0 python train_deepffam_wakeup_phones_xiaodu.py
...
if basic_args.pos_phone_file is not None:
    basic_args.pos_phone_file = os.path.join(basic_args.works_dir, basic_args.pos_phone_file)
